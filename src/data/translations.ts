...
export const translations = {
  ko: {
    ...
    accountBadge: "동기화 계정",
    authModalTitle: "연속일수 영구 보관하기",
    authModalDesc: "아이디를 등록하면 기기가 바뀌어도 소중한 연속 기록을 잃지 않아요.",
    authCurrentStreakLabel: "현재 내 연속 기록",
    authUserIdLabel: "아이디",
    authEmailLabel: "아이디",
    authPasswordLabel: "비밀번호 (6자 이상)",
    authLoginTitle: "로그인하여 동기화",
    authAccountTitle: "내 물 기록 계정",
    authLoggedInDesc: "아이디가 연결되어 연속일수가 클라우드에 실시간 보관 중입니다.",
    authRegisterSubmit: "1초 만에 연속 기록 저장하기",
    authLoginSubmit: "로그인하고 동기화",
    authToggleToLogin: "이미 아이디가 있으신가요? 로그인하기",
    authToggleToRegister: "아이디가 없으신가요? 간편 생성하기",
    authLogoutBtn: "로그아웃",
    authDeleteAccountBtn: "회원 탈퇴",
    authDeleteConfirmTitle: "정말 탈퇴하시겠습니까?",
    authDeleteWarning: "탈퇴 시 클라우드에 보관된 모든 연속 기록 및 계정 데이터가 영구히 삭제됩니다.",
    authDeletePasswordPlaceholder: "탈퇴 확인을 위해 비밀번호를 입력해주세요",
    authDeleteSubmit: "계정 삭제 및 탈퇴하기",
    authDeleteSuccess: "탈퇴가 완료되었습니다. 이용해 주셔서 감사합니다.",
    authCancelBtn: "취소",
    authLoginSuccess: "로그인되었습니다! 연속일수가 동기화되었습니다.",
    authRegisterSuccess: "등록 완료! 연속 기록이 영구 보관됩니다.",
  ...
  en: {
    ...
    statSourcePrefix: "Official Source",
    meLabel: "Me",
    ...
    accountBadge: "Synced Account",
    authModalTitle: "Save Your Water Streak",
    authModalDesc: "Create a User ID so you never lose your consecutive streak across devices.",
    authCurrentStreakLabel: "Current Streak",
    authUserIdLabel: "User ID",
    authEmailLabel: "User ID",
    authPasswordLabel: "Password (min 6 characters)",
    authLoginTitle: "Log In to Sync",
    authAccountTitle: "My Water Account",
    authLoggedInDesc: "Your ID is linked and your streak is synced in real-time.",
    authRegisterSubmit: "Save Streak in 1 Second",
    authLoginSubmit: "Log In & Sync",
    authToggleToLogin: "Already have a User ID? Log In",
    authToggleToRegister: "Don't have a User ID? Create One",
    authLogoutBtn: "Log Out",
    authDeleteAccountBtn: "Delete Account",
    authDeleteConfirmTitle: "Delete Account Confirmation",
    authDeleteWarning: "All cloud streak records and account data will be permanently erased.",
    authDeletePasswordPlaceholder: "Enter your password to confirm",
    authDeleteSubmit: "Permanently Delete Account",
    authDeleteSuccess: "Your account has been deleted successfully.",
    authCancelBtn: "Cancel",
    authLoginSuccess: "Logged in! Your streak has been synchronized.",
    authRegisterSuccess: "User ID registered! Your streak is now permanently saved.",
  ...
  ja: {
    ...
    accountBadge: "同期アカウント",
    authModalTitle: "連続記録を永久保存",
    authModalDesc: "IDを登録すると、端末が変わっても大切な連続記録が維持されます。",
    authCurrentStreakLabel: "現在の連続記録",
    authUserIdLabel: "ユーザーID",
    authEmailLabel: "ユーザーID",
    authPasswordLabel: "パスワード (6文字以上)",
    authLoginTitle: "ログインして同期",
    authAccountTitle: "水記録アカウント",
    authLoggedInDesc: "IDが連携され、連続記録がリアルタイムで同期されています。",
    authRegisterSubmit: "1秒で連続記録を保存",
    authLoginSubmit: "ログインして同期",
    authToggleToLogin: "すでにIDをお持ちですか？ログイン",
    authToggleToRegister: "IDをお持ちでないですか？簡単作成",
    authLogoutBtn: "ログアウト",
    authDeleteAccountBtn: "アカウント削除 (退会)",
    authDeleteConfirmTitle: "本当に退会しますか？",
    authDeleteWarning: "退会するとクラウドに保存されたすべての連続記録とアカウントデータが完全に削除されます。",
    authDeletePasswordPlaceholder: "確認のためパスワードを入力してください",
    authDeleteSubmit: "アカウントを完全に削除する",
    authDeleteSuccess: "退会が完了しました。ご利用ありがとうございました。",
    authCancelBtn: "キャンセル",
    authLoginSuccess: "ログインしました！連続記録が同期されました。",
    authRegisterSuccess: "ID登録完了！連続記録が永久保存されます。",
  ...
  zh: {
    ...
    accountBadge: "已同步账号",
    authModalTitle: "永久保存连续记录",
    authModalDesc: "设置账号ID后，无论在何处都能同步您的连续用水记录。",
    authCurrentStreakLabel: "当前连续记录",
    authUserIdLabel: "账号ID",
    authEmailLabel: "账号ID",
    authPasswordLabel: "密码 (至少6位)",
    authLoginTitle: "登录并同步",
    authAccountTitle: "我的水记录账号",
    authLoggedInDesc: "账号ID已关联，连续记录正实时同步中。",
    authRegisterSubmit: "1秒保存连续记录",
    authLoginSubmit: "登录并同步",
    authToggleToLogin: "已有账号ID？去登录",
    authToggleToRegister: "没有账号ID？快速创建",
    authLogoutBtn: "退出登录",
    authDeleteAccountBtn: "注销账号",
    authDeleteConfirmTitle: "确定要注销账号吗？",
    authDeleteWarning: "注销后，云端保存的所有连续记录和账号数据将被永久删除且无法恢复。",
    authDeletePasswordPlaceholder: "请输入密码以确认注销",
    authDeleteSubmit: "确认注销并删除账号",
    authDeleteSuccess: "账号已注销完毕。感谢您的使用。",
    authCancelBtn: "取消",
    authLoginSuccess: "登录成功！连续记录已同步。",
    authRegisterSuccess: "账号ID创建成功！连续记录已永久保存。",
